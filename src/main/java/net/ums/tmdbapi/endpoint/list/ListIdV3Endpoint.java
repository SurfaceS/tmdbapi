...
import net.ums.tmdbapi.schema.list.ListClearStatusSchema;
...
public class ListIdV3Endpoint extends Endpoint {
	 ...
	 * @return this endpoint
	 */
	public ListIdV3Endpoint setPage(int value) {
		this.page = value;
		return this;
	}
	...
	public ListClearStatusSchema clear() {
		return tmdbClient.get(V3_LIST_ENDPOINT + listId + LIST_CLEAR_ENDPOINT, ListClearStatusSchema.class, null);
	}
	...
	public StatusSchema delete() {
		return tmdbClient.delete(V3_LIST_ENDPOINT + listId, StatusSchema.class, null);
	}
	...
	public StatusSchema update() {
		...
		return tmdbClient.put(V3_LIST_ENDPOINT + listId, StatusSchema.class, null, jsonObject.toString());
	}
