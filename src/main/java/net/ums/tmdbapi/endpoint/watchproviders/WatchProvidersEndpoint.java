 ...
 */
package net.ums.tmdbapi.endpoint.watchproviders;

import net.ums.tmdbapi.TMDbClient;
import net.ums.tmdbapi.endpoint.Endpoint;
import net.ums.tmdbapi.schema.watchproviders.WatchProviderRegionsResponseSchema;
import net.ums.tmdbapi.schema.watchproviders.WatchProviderResponseSchema;
