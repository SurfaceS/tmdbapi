 ...
 * @author SurfaceS
 */
public class SearchMultiEndpoint extends Endpoint {

	private static final String V3_SEARCH_MULTI_ENDPOINT = V3_ENDPOINT + "search/multi";
	...
	public SearchMultiEndpoint(TMDbClient tmdbClient, String searchQuery) {
		super(tmdbClient);
	 ...
	 */
	public SearchMultiEndpoint includeAdultContent(boolean value) {
	 ...
	 * @return this request
	 */
	public SearchMultiEndpoint setLanguage(String value) {
		this.language = value;
		return this;
	}
	 ...
	 * @return this endpoint
	 */
	public SearchMultiEndpoint setPage(int value) {
		this.page = value;
		return this;
	}
	 ...
	 * @return this request
	 */
	public SearchMultiEndpoint setRegion(String value) {
	 ...
	 */
	public MediaTypedResultsSchema getResults() {
		...
		return tmdbClient.get(V3_SEARCH_MULTI_ENDPOINT, MediaTypedResultsSchema.class, query);
	}
